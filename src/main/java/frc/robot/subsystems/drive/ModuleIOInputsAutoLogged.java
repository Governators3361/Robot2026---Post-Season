...
public class ModuleIOInputsAutoLogged extends ModuleIO.ModuleIOInputs implements LoggableInputs, Cloneable {
    ...
    public ModuleIOInputsAutoLogged clone() {
        ...
        copy.drivePositionRad = drivePositionRad;
        copy.driveVelocityRadPerSec = driveVelocityRadPerSec;
        copy.driveAppliedVolts = driveAppliedVolts;
        copy.driveCurrentAmps = driveCurrentAmps;
        copy.turnConnected = turnConnected;
        copy.turnPosition = turnPosition;
        copy.turnVelocityRadPerSec = turnVelocityRadPerSec;
        copy.turnAppliedVolts = turnAppliedVolts;
        copy.turnCurrentAmps = turnCurrentAmps;
        copy.odometryTimestamps = odometryTimestamps.clone();
        copy.odometryDrivePositionsRad = odometryDrivePositionsRad.clone();
        copy.odometryTurnPositions = odometryTurnPositions.clone();
        return copy;
    }
}
